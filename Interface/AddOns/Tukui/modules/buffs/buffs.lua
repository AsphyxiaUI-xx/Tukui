...
local function UpdateWeapons(button, slot, active, expiration)
	if not button.texture then
		...
		button.time:SetPoint("BOTTOM", 0, T.Scale(-7))
...
local function CreateAuraHeader(filter, ...)
	...
	header:SetAttribute("wrapYOffset", -46)
...
ScanAuras(CreateAuraHeader("HELPFUL", "TOPRIGHT", -170, -10))
ScanAuras(CreateAuraHeader("HARMFUL", "TOPRIGHT", -170, -140))
