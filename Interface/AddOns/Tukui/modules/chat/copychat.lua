...
local function ChatCopyButtons()
	for i = 1, NUM_CHAT_WINDOWS do
		...
		buttontext:SetText(T.StatColor.."Copy")
		...
		button:SetScript("OnEnter", function() button:SetAlpha(10) buttontext:SetText(T.StatColor.."Copy") end)
		
		local bnb = function() -- just to shorten the code
			button:SetAlpha(10)
			button:SetScript("OnLeave", function() button:SetAlpha(10) buttontext:SetText(T.StatColor.."Copy") end)
		...
		if point == "BOTTOMLEFT" or point == "LEFT" then
			if C.chat.leftchatbackground then
				button:SetScript("OnLeave", function() buttontext:SetText(T.StatColor.."Copy") end)
