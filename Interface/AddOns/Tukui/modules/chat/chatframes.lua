...
local function SetChatStyle(frame)
	...
	_G[chat]:SetMinResize(371,109)
	_G[chat]:SetMinResize(T.InfoLeftRightWidth + 1,109)
...
local function SetupChatPosAndFont(self)	
	for i = 1, NUM_CHAT_WINDOWS do
		...
		if i == 1 then
			chat:Point("BOTTOMLEFT", TukuiInfoLeft, "TOPLEFT", 0, 7)
			chat:Point("BOTTOMRIGHT", TukuiInfoLeft, "TOPRIGHT", 0, 7)
			FCF_SavePositionAndDimensions(chat)
		elseif i == 5 and name == LOOT then
			if not chat.isDocked then
				chat:ClearAllPoints()
				chat:Point("BOTTOMRIGHT", TukuiInfoRight, "TOPRIGHT", 0, 7)
				chat:Point("BOTTOMLEFT", TukuiInfoRight, "TOPLEFT", 0, 7)
