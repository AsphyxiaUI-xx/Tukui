...
locpanel:CreatePanel("Default", 70, 23, "TOP", UIParent, "TOP", 0, -40)
...
Tukuitopp:CreatePanel(topp, 1, 12, "BOTTOM", TukuiLocationPanel, "TOPLEFT", 8, 0)
Tukuitopp:CreateShadow(topp)
topp:SetFrameLevel(0)

-- Coords line (right)
local topp2 = CreateFrame("Frame", "Tukuitopp2", UIParent)
Tukuitopp2:CreatePanel(topp2, 1, 12, "BOTTOM", TukuiLocationPanel, "TOPRIGHT", -8, 0)
