...
WORLDMAP_WINDOWED_SIZE = 0.72 --Slightly increase the size of blizzard small map
local mapscale = WORLDMAP_WINDOWED_SIZE

local ft = C["media"].pixelfont -- Map font
local fontsize = 14 -- Map Font Size
...
local SmallerMapSkin = function()
	...
	WorldMapQuestShowObjectivesText:Point("LEFT", WorldMapQuestShowObjectives, "RIGHT", 2, 1)
	...
	WorldMapShowDigSitesText:Point("LEFT", WorldMapShowDigSites, "RIGHT", 2, 1)
	...
	WorldMapFrameAreaLabel:SetFont(ft, fontsize*1.4, "OUTLINE")
...
coords.PlayerText = T.SetFontString(CoordsFrame, ft, 10, "THINOUTLINE")
coords.MouseText = T.SetFontString(CoordsFrame, ft, 10, "THINOUTLINE")
