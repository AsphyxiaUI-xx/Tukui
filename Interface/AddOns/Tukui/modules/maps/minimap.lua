...
TukuiMinimap:Point("TOPRIGHT", UIParent, "TOPRIGHT", -7, -7)
...
MiniMapBattlefieldFrame:Point("BOTTOMRIGHT", Minimap, 3, 6)
...
local function UpdateLFG()
	...
	MiniMapLFGFrame:Point("BOTTOMRIGHT", Minimap, "BOTTOMRIGHT", 2, 6)
