...
-- create the bar
local TukuiThreatBar = CreateFrame("StatusBar", "TukuiThreatBar", TukuiInfoLeft)
...
TukuiThreatBar.text = T.SetFontString(TukuiThreatBar, C.media.pixelfont, 10, "THINOUTLINE")
TukuiThreatBar.text:Point("RIGHT", TukuiThreatBar, "RIGHT", -30, 1)

TukuiThreatBar.Title = T.SetFontString(TukuiThreatBar, C.media.pixelfont, 10, "THINOUTLINE")
