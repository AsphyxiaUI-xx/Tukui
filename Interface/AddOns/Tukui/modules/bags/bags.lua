...
function Stuffing:CreateBagFrame(w)
	...
	f.b_close:HookScript("OnEnter", function(self) f.b_close:SetBackdropBorderColor(unpack(TukuiCF["media"].statcolor)) end)
	f.b_close:HookScript("OnLeave", function(self) f.b_close:SetBackdropBorderColor(unpack(TukuiCF["media"].backdropcolor)) end)
	...
	if w == "Bags" then
		...
		f.b_key:HookScript("OnEnter", function(self) f.b_key:SetBackdropBorderColor(unpack(TukuiCF["media"].statcolor)) end)
		f.b_key:HookScript("OnLeave", function(self) f.b_key:SetBackdropBorderColor(unpack(TukuiCF["media"].backdropcolor)) end)
	end
...
function Stuffing:Layout(lb)
	...
	if lb then
		...
		f.detail:Point("TOPLEFT", f, 12, -14)
