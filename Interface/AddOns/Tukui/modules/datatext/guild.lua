...
local displayString = string.join("", "%s: ", "|cffFFFFFF", hexa.."%d|r")
local guildInfoString = "%s - %d-й "..LEVEL_ABBR
...
Stat:SetScript("OnEnter", function(self)
	...
	if online > 1 then
		...
		for i = 1, #guildTable do
			if online <= 1 then
				if online > 1 then GameTooltip:AddLine(format("+ %d еще...", online - modules.Guild.maxguild),ttsubh.r,ttsubh.g,ttsubh.b) end
				break
			end
