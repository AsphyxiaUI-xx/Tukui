...
if C["datatext"].hps_text and C["datatext"].hps_text > 0 then
	...
	hText:SetText(L.datatext_hps..hexa.."0.0")
	...
	function get_hps()
		if (actual_heals_total == 0) then
			return (L.datatext_hps..hexa.."0.0"..hexb)
		else
			return string.format(L.datatext_hps..hexa.."%.1f ", (actual_heals_total or 0) / (cmbt_time or 1))
		end
	end
