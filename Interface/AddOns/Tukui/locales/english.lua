...
L.popup_install = "First time running |cff3300FFTukui Asphyxia's Edit|r, version 1.1.3"..T.asphyxiarelease.." with this Character. You must reload your UI to set Action Bars, Variables and Chat Frames."
...
L.core_welcome1 = "Hey, |cffFF6347"..myPlayerName.."|r. Welcome to |cff0066FFTukui Asphyxia's Edit|r, version 1.1.3"
