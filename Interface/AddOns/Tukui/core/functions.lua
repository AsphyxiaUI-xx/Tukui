...
T.PP = function(p, obj)
	...
	local centerbottom = TukuiInfoCenterBottom
	local minimapleftinfo = TukuiInfoLeftMinimap
	local minimaprightinfo = TukuiInfoRightMinimap
	...
	elseif p == 8 then
		obj:SetParent(TukuiTopStat1)
		obj:Height(TukuiTopStat1:GetHeight())
		obj:Point("CENTER", TukuiTopStat1, 0, 1)
	elseif p == 9 then
		obj:SetParent(TukuiTopStat2)
		obj:Height(TukuiTopStat2:GetHeight())
		obj:Point("CENTER", TukuiTopStat2, 0, 1)
	elseif p == 10 then
		obj:SetParent(TukuiTopStat3)
		obj:Height(TukuiTopStat3:GetHeight())
		obj:Point("CENTER", TukuiTopStat3, 0, 1)
	elseif p == 11 then
	...
	elseif p == 15 then
		obj:SetParent(centerbottom)
		obj:SetHeight(centerbottom:GetHeight())
		obj:SetPoint('TOP', centerbottom, 0, 1)
		obj:SetPoint('BOTTOM', centerbottom)
	elseif p == 16 then
		obj:SetParent(TukuiInfoCenterBottomRight)
		obj:SetHeight(TukuiInfoCenterBottomRight:GetHeight())
		obj:SetPoint('TOP', TukuiInfoCenterBottomRight, 0, 1)
		obj:SetPoint('BOTTOM', TukuiInfoCenterBottomRight)	
	end
end
...
T.DataTextTooltipAnchor = function(self)
	...
	elseif panel == TukuiInfoLeftMinimap or panel == TukuiInfoRightMinimap then
...
T.PostCreateAura = function(element, button)
	...
	button.remaining = T.SetFontString(button, C["media"].pixelfont, C["unitframes"].auratextscale, "THINOUTLINE")
...
T.MLAnchorUpdate = function (self)
	if self.Leader:IsShown() then
		self.MasterLooter:SetPoint("TOPLEFT", -23, 10)
	else
		self.MasterLooter:SetPoint("TOPLEFT", -9, 10)
	end
end
...
T.UpdateDruidMana = function(self)
	...
	if num ~= 0 then
		...
		if percMana <= C["unitframes"].lowThreshold then
			...
			T.Flash(self.FlashInfo, 0.3)
		else
			self.FlashInfo.ManaLevel:SetText()
			T.StopFlash(self.FlashInfo)
		end
...
if C["unitframes"].raidunitdebuffwatch == true then
	...
	do
		...
		--Throne of the Four Winds
			...
			SpellName(93280), -- Lightning Rod
			--SpellName(11196), -- test
		}
