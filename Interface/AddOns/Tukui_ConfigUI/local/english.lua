...
TukuiL.option_datatext_specswitcher = "Specswitcher (0 for disabled)"
...
TukuiL.option_unitframes_showsolo = "Show raid frames when solo (Heal only)"
TukuiL.option_unitframes_classiconportrait = "Show class icon intead of player model"
