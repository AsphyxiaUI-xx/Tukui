if GetLocale() == "ruRU" then
	...
	TukuiL.option_datatext_specswitcher = "Отображение и смена специализации (0 для отключения)"
	...
	TukuiL.option_unitframes_aurawatch = "Включить показ рейдовых аур PVE"
	...
	TukuiL.option_unitframes_healcomm = "Отображать входящие лечение"
	...
	TukuiL.option_unitframes_showfocustarget = "Отображать цель фокуса"
	TukuiL.option_unitframes_showsolo = "Отображать рейд фреймы вне группы (только Heal раскладка)"
	TukuiL.option_unitframes_classiconportrait = "Отображать иконку класса ввиде портрета игрока вместо модели"
	TukuiL.option_unitframes_extendedpet = "Расширенный фрейм питомца"
	...
	TukuiL.option_map_location_panel = "Включить панель координат"
...
TukuiL.option_auras_player = "Включить Tukui фреймы баффов/дебаффов"
